        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <a href="/teacher/calendar" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-red-900 hover:shadow-md transition group">
                        <div class="w-12 h-12 bg-red-50 rounded-lg flex items-center justify-center mb-2 group-hover:bg-red-100 transition">
                    ...
                    <a href="/teacher/class-record" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-red-900 hover:shadow-md transition group">
                        <div class="w-12 h-12 bg-red-50 rounded-lg flex items-center justify-center mb-2 group-hover:bg-red-100 transition">
                            <svg class="w-6 h-6 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                        </div>
                        <span class="text-sm font-medium text-gray-900">Class Record</span>
                    </a>
                    <a href="/teacher/reports" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-red-900 hover:shadow-md transition group">
                        <div class="w-12 h-12 bg-red-50 rounded-lg flex items-center justify-center mb-2 group-hover:bg-red-100 transition">
                            <svg class="w-6 h-6 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/teacher/my-courses" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-red-900 hover:shadow-md transition group">
                        <div class="w-12 h-12 bg-red-50 rounded-lg flex items-center justify-center mb-2 group-hover:bg-red-100 transition">
                            <svg class="w-6 h-6 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
